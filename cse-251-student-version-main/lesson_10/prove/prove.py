...
- More like I need to sleep amirite
...
"""
# I couldn't get to this in an adequate time frame.
import random
...
def main():
    ...
    reader_processes = [mp.Process(target=reader, args=(shared_list, lock, full, empty)) for _ in range(READERS)]
    writer_processes = [mp.Process(target=writer, args=(shared_list, lock, full, empty, items_to_send)) for _ in range(WRITERS)]
    ...
    # I stopped here!
    #print(f'{shared_list} values received')
...
if __name__ == '__main__':
    main()
    #Critical section with a lock
    #Race Condition a block of code you need to protect.